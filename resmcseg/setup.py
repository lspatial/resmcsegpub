...
ext=Extension(
        'resmcseg._metrics',
        ['src/bindings.cpp','src/cmetrics.cpp'],
        include_dirs=[
...
kwargs = dict(
    ...
    description='Library for Deep Residual Multiscale Segmenter',
    long_description=long_description,
    long_description_content_type='text/markdown',
    ext_modules=[ext],
    cmdclass=dict(build_ext=BuildExt),
    zip_safe=False, 
    packages=['resmcseg','resmcseg.data','resmcseg.util','resmcseg.model'],
    #packages=['resmcseg'],
