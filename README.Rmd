---
title: "resmcseg: Library for Deep Residual Multiscale Segmenter"
...
```{python echo=TRUE,results='hide', message=F, warning=F}
import numpy as np
...
<img  align="center" src="figs/CNN_architecture.png"  style="zoom:30%"  hspace="2"/>
...
<img  align="center" src="figs/workflow.png"  style="zoom:40%"  hspace="2"/>
...
<p style="float: left; font-size: 9pt; text-align: center; width: 46%;height: 100%; margin-right: auto; margin-bottom: 0.5em;"><img src="figs/kldata_premask.png" style="zoom:13%">DSTL images</p>
<p style="float: left; font-size: 9pt; text-align: center; width: 54%;height: 100%; margin-right: auto; margin-bottom: 0.5em;"><img src="figs/zurich_pre_masks.png" style="zoom:22%">Zurich images</p>
